...
Trang này ghi lại toàn bộ quá trình học tập, nghiên cứu và thực hành thực tế của tôi trong suốt giai đoạn tham gia chương trình **First Cloud AI Journey (FCAJ)**. Nhật ký công việc (Worklog) được xây dựng theo từng tuần nhằm theo dõi sát sao tiến độ hoàn thành mục tiêu, các kỹ năng kỹ thuật đã tích lũy và kết quả đạt được trên nền tảng điện toán đám mây Amazon Web Services (AWS).
...
* **Tuần 3:** [Nghiên cứu các dịch vụ Lưu trữ (S3, EBS), Cơ sở dữ liệu (RDS, DynamoDB) và tham gia sự kiện chuyên gia AWS](1.3-week3/)
* **Tuần 4:** [Hệ thống hóa kiến thức cốt lõi chuẩn bị thi chứng chỉ AWS Cloud Practitioner và học kỹ thuật Networking nâng cao (VPC nâng cao)](1.4-week4/)
* **Tuần 5:** [Tập trung ôn tập toàn diện 6 Module đầu, làm chủ kiến thức Cloud Practitioner và hoàn thành Lab Networking nâng cao](1.5-week5/)
* **Tuần 6:** [Nghiên cứu kiến trúc High Availability (Auto Scaling, ELB), dịch vụ Giám sát (CloudWatch, CloudTrail) và bảo mật nâng cao (NACL, Security Group)](1.6-week6/)
* **Tuần 7:** [Tìm hiểu mô hình bảo mật nhiều lớp, kiến trúc không máy chủ (Serverless với Lambda, API Gateway) và quản trị DNS toàn cầu (Route 53)](1.7-week7/)
